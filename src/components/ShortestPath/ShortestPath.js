...
const ShortestPath = () => {
  const constantPositions = [[37.7749, -122.4194 ]];
    ...
    <div className="container">
      <div className="top-container">
        ...
        <div className="autocomplete-container">
          ...
          <div className="top-autocomplete3">
...
<div className="bottom-container">
        <Button variant="outlined" color="primary" id="VDMButton" onClick={handleClickOpen1}>
      ...
      <div className="bottom-container2">
        <Button variant="outlined" color="primary" id = "VOMButton" onClick={handleClickOpen2}>
