...
*/
import img1 from "../../image/roadsign.jpeg";
import img2 from "../../image/stop_sign.jpeg";
import img3 from "../../image/car.png";
import img4 from "../../image/roadblock.jpg";
import img5 from "../../image/roadblocker.png";
import img6 from "../../image/accident1.png";
...
const locations = [
  ...
  { id: 1, name: "San Jose", lat: 37.3382, lon: -121.8863 },
  { id: 2, name: "Sacramento", lat: 38.5816, lon: -121.4944 },
  { id: 3, name: "Oakland", lat: 37.8049, lon: -122.2711 },
  { id: 4, name: "Berkeley", lat: 37.8715, lon: -122.2730 },
  { id: 5, name: "Palo Alto", lat: 37.4419, lon: -122.1430 },
  { id: 6, name: "Fremont", lat: 37.5485, lon: -121.9886 },
  { id: 7, name: "Santa Rosa", lat: 38.4405, lon: -122.7141 },
  { id: 8, name: "Napa", lat: 38.5025, lon: -122.2654 },
  { id: 9, name: "Sonoma", lat: 38.2919, lon: -122.4580 },
  { id: 10, name: "Mountain View", lat: 37.3861, lon: -122.0838 },
  { id: 11, name: "Santa Clara", lat: 37.3541, lon: -121.9552 },
  { id: 12, name: "Sunnyvale", lat: 37.3688, lon: -122.0363 },
  { id: 13, name: "Redwood City", lat: 37.4852, lon: -122.2364 },
  { id: 14, name: "Hayward", lat: 37.6688, lon: -122.0808 },
  { id: 15, name: "Livermore", lat: 37.6819, lon: -121.7680 },
  { id: 16, name: "Stockton", lat: 37.9577, lon: -121.2908 },
  { id: 17, name: "Modesto", lat: 37.6391, lon: -120.9969 },
  { id: 18, name: "Chico", lat: 39.7285, lon: -121.8375 },
  { id: 19, name: "Eureka", lat: 40.8021, lon: -124.1637 },
...
const Blockers = () => {
  ...
  return (
    <div className="blocker">
      ...
      <img className="floating-logo" src={img1} height={200} width={200} alt="Logo 1" style={{ left: '10%', top: '20%' }} />
      <img className="floating-logo" src={img2} height={850} width={600} alt="Logo 2" style={{ left: '65%', top: '20%' }} />
      <img className="floating-logo" src={img3} height={300} width={300} alt="Logo 2" style={{ left: '25%', top: '50%' }} />
      <img className="floating-logo" src={img4} height={300} width={300} alt="Logo 2" style={{ left: '50%', top: '60%' }} />
      <img className="floating-logo" src={img5} height={200} width={200} alt="Logo 2" style={{ left: '10%', top: '70%' }} />
      <img className="floating-logo" src={img6} height={200} width={200} alt="Logo 2" style={{ left: '0.5%', top: '50%' }} />
